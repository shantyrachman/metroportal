...
<html lang="en">
  <head>
    ...
    <title>Portal Berita | Berita terbaru</title>
    <!-- Bootstrap -->
    ...
    <!-- Bootbusiness theme -->
    <link href="asset/css/boot-business.css" rel="stylesheet">
  ...
  <body>
              ...
              <div class="active item">
                <div class="hero-unit">
                  <div class="row-fluid">
                    ...
                    <div class="span5">
                      <img src="asset/img/placeholder.jpg" class="thumbnail">
                    </div>
                  </div>                  
                </div>
              </div>
        ...
        <div class="container">
          ...
          <div class="row-fluid">
            <ul class="thumbnails">
              <li class="span4">
                <div class="thumbnail">
                  <img src="asset/img/placeholder-360x200.jpg" alt="product name">
                  <div class="caption">
                    <h3>Product name</h3>
                    <p>
    ...
    <script type="text/javascript" src="asset/js/boot-business.js"></script>
  </body>
</html>
